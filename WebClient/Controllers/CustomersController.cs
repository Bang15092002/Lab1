    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (httpResponseMessage.IsSuccessStatusCode)
            {
                ...
                var customer = await JsonSerializer.DeserializeAsync<IEnumerable<CusDTO>>(contentStream);
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Password,Fullname,Gender,Birthday,Address")] CusDTO customer)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            if (httpResponseMessage.IsSuccessStatusCode)
            {
                ...
                var customer = await JsonSerializer.DeserializeAsync<CusDTO>(contentStream);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Password,Fullname,Gender,Birthday,Address")] CusDTO customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
